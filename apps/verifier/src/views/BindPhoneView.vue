    ...
    <Transition name="fade-up">
      <div v-if="openHotelSelect" class="sheet-mask" @click.self="openHotelSelect = false">
        <section class="sheet-panel">
          ...
          <button type="button" class="sheet-confirm" :disabled="!selectedHotel" @click="confirmHotel">
            确认
          </button>
        </section>
      </div>
...
import { hotelOptions } from '../data/mock';
...
const selectedHotel = ref('深圳格兰云天酒店');
